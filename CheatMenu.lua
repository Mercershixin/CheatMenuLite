print(('[CheatMenu] build 2026-09-25 20:45 sha 99f1f29d bytes 527356'):format('2026-09-25 20:45','99f1f29d',527356))
...
local kY=(sensY>0) and sensY or 0.0016               local kP=(sensP>0) and sensP or 0.0016
